...
[CI for the previous `1fe6dd25a` head](https://fload.semaphoreci.com/workflows/b2c5ecd3-c2f4-4494-b565-de0eb57ec8b0?pipeline_id=3da151de-1d3a-489f-b647-b9271a30163f) finished with two namespace fixture failures and a web tracking teardown failure; all three are corrected in this published checkpoint. Other required blocks passed. All required test blocks passed at `f76b2262c`, including ordinary integration, Actions migrations/reliability and deterministic web checks. The direct-branch review block had no review job. CI for newer integration head `641b73b86` remains pending; earlier results do not certify it. No independent GitHub PR-review or full-readiness claim.
