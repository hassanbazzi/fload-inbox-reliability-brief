...
| C5 · Attention for evidence capture | Explicitly follows ownership v6: canonical writer derives the delta. These historical evidence-only captures add one workflow version and zero attention; no personal read marks change. They do not inherit v15's broad observation-attention wording |
